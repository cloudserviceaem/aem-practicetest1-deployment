 ...
 */
package com.practice.test1.deployment.core.models;
...
import com.practice.test1.deployment.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "practicetest1/components/helloworld");
